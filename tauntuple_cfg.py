...
process.NtupleMaker.EleMVAWeights1 = cms.untracked.string('src/data/Electrons_BDTG_TrigNoIPV0_2012_Cat1.weights.xml')
process.NtupleMaker.EleMVAWeights2 = cms.untracked.string('src/data/Electrons_BDTG_TrigNoIPV0_2012_Cat2.weights.xml')
process.NtupleMaker.EleMVAWeights3 = cms.untracked.string('src/data/Electrons_BDTG_TrigNoIPV0_2012_Cat3.weights.xml')
process.NtupleMaker.EleMVAWeights4 = cms.untracked.string('src/data/Electrons_BDTG_TrigNoIPV0_2012_Cat4.weights.xml')
process.NtupleMaker.EleMVAWeights5 = cms.untracked.string('src/data/Electrons_BDTG_TrigNoIPV0_2012_Cat5.weights.xml')
process.NtupleMaker.EleMVAWeights6 = cms.untracked.string('src/data/Electrons_BDTG_TrigNoIPV0_2012_Cat6.weights.xml')
...
process.p  = cms.Path(process.EvntCounterA*process.MultiTrigFilter*process.recoTauClassicHPSSequence*process.PreselectionCuts*process.type0PFMEtCorrection*process.producePFMETCorrections*process.EvntCounterB*process.NtupleMaker)
